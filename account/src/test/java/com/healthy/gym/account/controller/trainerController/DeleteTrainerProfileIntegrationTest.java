...
@Tag("integration")
class DeleteTrainerProfileIntegrationTest {
    ...
    private Resource imageResourceTrainer;
    ...
    void setUp() throws IOException {
        ...
        Resource trainingTypeImageResource = new ClassPathResource("testImagess/shiba_inu_smile_1.jpg");
        ...
        trainingTypeDocument.setImageDocument(trainingTypeSavedImageDocument);
    ...
    void shouldReturnDeletedTrainerProfileWithImageUrl(TestCountry country) throws URISyntaxException, IOException {
        testDatabase(1,1, 1, 2);
        ...
        String expectedMessage = messages.get("trainer.removed");
    ...
    private String getExpectedImageBase64() throws IOException {
        File imageFile = imageResourceTrainer.getFile();
        FileInputStream inputStream = new FileInputStream(imageFile);
