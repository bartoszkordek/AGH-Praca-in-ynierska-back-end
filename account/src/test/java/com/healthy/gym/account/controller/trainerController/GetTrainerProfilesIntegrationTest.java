...
@Tag("integration")
class GetTrainerProfilesIntegrationTest {
    @Container
    ...
    @Nested
    class ShouldAcceptRequestAndShouldResponseWithProperTrainers {
        @ParameterizedTest
        ...
        @ParameterizedTest
        @EnumSource(TestCountry.class)
        void shouldReturnNotNullUserIds(TestCountry country) throws URISyntaxException {
            ResponseEntity<JsonNode> responseEntity = getResponseEntity(country);
            assertThat(responseEntity.getBody().get(0).get("userId")).isNotNull();
            assertThat(responseEntity.getBody().get(0).get("userId").textValue()).isEqualTo(userId1);
            assertThat(responseEntity.getBody().get(1).get("userId")).isNotNull();
            assertThat(responseEntity.getBody().get(1).get("userId").textValue()).isEqualTo(userId2);
        }

        @ParameterizedTest
        @EnumSource(TestCountry.class)
        void shouldReturnProperNames(TestCountry country) throws URISyntaxException, IOException {
            ResponseEntity<JsonNode> responseEntity = getResponseEntity(country);
            assertThat(responseEntity.getBody().get(0).get("name")).isNotNull();
            assertThat(responseEntity.getBody().get(0).get("name").textValue()).isEqualTo("Jan");
            assertThat(responseEntity.getBody().get(1).get("name")).isNotNull();
            assertThat(responseEntity.getBody().get(1).get("name").textValue()).isEqualTo("Paweł");
        }

        @ParameterizedTest
        @EnumSource(TestCountry.class)
        void shouldReturnProperSurnames(TestCountry country) throws URISyntaxException, IOException {
            ResponseEntity<JsonNode> responseEntity = getResponseEntity(country);
            assertThat(responseEntity.getBody().get(0).get("surname")).isNotNull();
            assertThat(responseEntity.getBody().get(0).get("surname").textValue()).isEqualTo("Kowalski");
            assertThat(responseEntity.getBody().get(1).get("surname")).isNotNull();
            assertThat(responseEntity.getBody().get(1).get("surname").textValue()).isEqualTo("Borsuk");
        }
        ...
        void shouldReturnProperDescription(TestCountry country) throws URISyntaxException {
            ...
            assertThat(responseEntity.getBody().get(0).
                    get("description").get("synopsis").textValue()).isEqualTo("Sample synopsis 1");
            assertThat(responseEntity.getBody().get(0).
                    get("description").get("full").textValue()).isEqualTo("Sample full 1");
            assertThat(responseEntity.getBody().get(0).
        ...
        private ResponseEntity<JsonNode> getResponseEntity(TestCountry country) throws URISyntaxException {
            ...
            URI uri = new URI("http://localhost:" + port +"/trainer");
    ...
    @Nested
    class ShouldAcceptRequestAndShouldResponseWithNotFoundTrainerProfiles {
