...
public class Messages {
    private static Map<String, String> getMessagesPL() {
        return Stream.of(new String[][]{
                ...
                {"exception.invalid.page.format", "Nieprawidłowy format. Zastosuj jedną z liczb: 5, 10, 20, 50 or 100."},
                {"exception.invalid.size.format",
    ...
    private static Map<String, String> getMessagesEN() {
        return Stream.of(new String[][]{
                ...
                {"exception.invalid.page.format", "Invalid format. Use one of the numbers: 5, 10, 20, 50 or 100."},
                {"exception.invalid.size.format", "Invalid format. Use an integer between 1 and 2,147,483,647."},
