...
public class Messages {
    private static Map<String, String> getMessagesPL() {
        return Stream.of(new String[][]{
                ...
                {"gympass.removed", "Karnet został usunięty."},
                {"gympass.valid", "Karnet jest ważny."},
                {"gympass.not.valid.retro.end.date", "Karnet nie jest ważny. Minęła data ważności."},
                {"gympass.not.valid.no.entries", "Karnet nie jest ważny. Brak wejść."},
                {"gympass.not.valid.suspended", "Karnet jest zawieszony."},
                {"exception.no.gympasses", "Brak karnetów."},
    ...
    private static Map<String, String> getMessagesEN() {
        return Stream.of(new String[][]{
                ...
                {"gympass.removed", "Gympass has been removed."},
                {"gympass.valid", "Gympass is valid."},
                {"gympass.not.valid.retro.end.date", "Gympass is not valid. Retro end date."},
                {"gympass.not.valid.no.entries", "Gympass is not valid. No entries."},
                {"gympass.not.valid.suspended", "Gympass is suspended."},
                {"exception.no.gympasses", "No gympasses."},
