...
@Tag("integration")
class EnrollToGroupTrainingReserveListIntegrationTest {
    ...
    private void testUpdatedGroupTrainingStoredInDB() {
        ...
        assertThat(groupTraining.getReserveList().size()).isEqualTo(2);

        UserDocument user2 = groupTraining.getReserveList().get(0);
        assertThat(user2.getUserId()).isEqualTo(testUserId2);

        UserDocument user = groupTraining.getReserveList().get(1);
