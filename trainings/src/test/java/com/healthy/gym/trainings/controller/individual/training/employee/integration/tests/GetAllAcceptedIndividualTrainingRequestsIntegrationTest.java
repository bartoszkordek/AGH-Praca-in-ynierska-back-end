...
class GetAllAcceptedIndividualTrainingRequestsIntegrationTest {
    ...
    private URI getUri(String startDate, String endDate, String pageNumber, String pageSize)
        ...
        return new URI("http://localhost:" + port + "/individual/employee/accepted"
                + "?startDate=" + startDate
                + "&endDate=" + endDate
    ...
    @CsvSource({
            ...
            "2021-01-05,2021-01-06,0,20,2",
            "2021-01-05,2021-01-10,0,5,5",
            "2021-01-05,2021-01-10,1,5,1",
            "2021-01-01,2021-01-05,0,10,3"
    })
    void shouldGetAllAcceptedIndividualTrainingRequests(
            String startDate,
            String endDate,
            String pageNumber,
            String pageSize,
