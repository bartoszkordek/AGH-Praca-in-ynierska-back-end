...
class NotificationServiceIntegrationTest {
    ...
    class ShouldSendNotificationWithoutEmailsWhenRemovingGroupTraining {
        ...
        void shouldContainSameContent() {
            ...
            String expectedContent = messages.get("notification.group.training.cancelled");
    ...
    class ShouldSendNotificationWithEmailsWhenRemovingGroupTraining {
        ...
        void shouldSendEmail() {
            ...
            String expectedMessage = responseMessages.get("notification.group.training.cancelled");
